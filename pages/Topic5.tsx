...
import { MindfulnessPerjuangan, BattleStrategySim, QuizPerjuanganFisik } from '../components/Topic5Components';
    ...
    return (
        <div className="fade-in pb-12">
            ...
            <div className="max-w-7xl mx-auto px-4">
                {activeTab === 'materi' && (
                    <div className="animate-fade-in grid md:grid-cols-12 gap-10">
